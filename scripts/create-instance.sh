...
echo -e "${CYAN}Creating new OpenClaw instance: ${NC}${GREEN}$INSTANCE_NAME${NC}"
echo ""
...
# OpenClaw Instance Configuration: $INSTANCE_NAME
...
tags:
  Owner: your-name
  Project: openclaw-${INSTANCE_NAME}
  Environment: prod
EOF
...
# Terraform configuration for OpenClaw instance: INSTANCE_NAME_PLACEHOLDER
...
provider "aws" {
  ...
  default_tags {
    tags = {
      Project     = "openclaw-INSTANCE_NAME_PLACEHOLDER"
...
module "openclaw" {
  ...
  # Naming
  project_name = "openclaw-INSTANCE_NAME_PLACEHOLDER"
  environment  = "prod"
...
echo -e "     ${YELLOW}./scripts/pepper $INSTANCE_NAME terraform init${NC}"
echo ""
echo "  3. Deploy infrastructure:"
echo -e "     ${YELLOW}./scripts/pepper $INSTANCE_NAME terraform apply${NC}"
echo ""
echo "  4. Connect and configure:"
echo -e "     ${YELLOW}./scripts/pepper $INSTANCE_NAME ssh${NC}"
echo "     sudo -u clawd -i"
echo "     openclaw onboard"
echo ""
echo "  5. Access admin UI:"
echo -e "     ${YELLOW}./scripts/pepper $INSTANCE_NAME connect${NC}"
echo ""
